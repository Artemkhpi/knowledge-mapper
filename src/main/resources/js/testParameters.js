function getDifficultyLevels() {
    return AJS.$.get("/../confluence/rest/test-rest/latest/difficultyLevel");
}

function getLabels() {
    return AJS.$.get("/../confluence/rest/test-rest/latest/label");
}

function getScopes() {
    return AJS.$.get("/../confluence/rest/test-rest/latest/scope");
}
        ...
        "fields": {
            ...
            "string": {
                "labelSelector": function (param) {
                    //return handleLabelSelectorLookup();
